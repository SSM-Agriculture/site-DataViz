...
Le nombre [d'exploitaton de moins de 100&nbsp;ha]{.highlight-orange} recule tandis que celui des plus grandes augmentes. Pour autant, **les exploitation de moins de 50&nbsp;ha sont toujours majoritaires (54&nbsp;% en 2020)**. @cr-nb-exp
...
A l'opposé, le nombre d'exploitations de [plus de 200&nbsp;ha]{.highlight-orange} augmente d'un tiers entre 2010 et 2020. @cr-nb-exp2
...
# Exploitation avec un SAU nulle
...
# Evolution par type e culture en métropole
...
<p>
  ...
  , afin d'assoir une production nationale.
</p>
```
...
<div id="map-container">
  <iframe src="carte_vierge.html" id="map"></iframe>
</div>
```
:::
...
A l'opposé, dans le Sud-Est et dans les [Landes]{.highlight-green} ou la [Gironde]{.highlight-green}, ce sont plutôt des forêts, montagnes ou zones humides. @cr-map
